...
class MyFtcEventLoopIdle(hardwareFactory: HardwareFactory,
                         userOpmodeRegister: OpModeRegister,
                         callback: UpdateUI.Callback,
                         activityContext: Activity,
                         programmingModeController: ProgrammingModeController)
	: FtcEventLoopIdle(hardwareFactory, userOpmodeRegister, callback, activityContext, programmingModeController) {
