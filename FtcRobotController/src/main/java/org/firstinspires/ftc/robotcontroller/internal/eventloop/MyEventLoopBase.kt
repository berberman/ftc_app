...
abstract class MyEventLoopBase(hardwareFactory: HardwareFactory,
                               userOpmodeRegister: OpModeRegister,
                               callback: UpdateUI.Callback,
                               activityContext: Activity,
                               programmingModeController: ProgrammingModeController)
	: FtcEventLoopBase(hardwareFactory, userOpmodeRegister, callback, activityContext, programmingModeController) {
